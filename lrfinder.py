...
net = rnn_attention.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout,
...
def lrs(batch):
    low = math.log2(1e-5)
    high = math.log2(10)
    return 2**(low+(high-low)*batch/args.batch_size/args.num_epoch)
